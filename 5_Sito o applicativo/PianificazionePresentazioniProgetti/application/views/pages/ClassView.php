                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <div class="collapse.open" id="collapseLayouts" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" style="color:white">Classi</a>
                    ...
                    <div class="sb-sidenav-footer">
                        ...
                        <button type="button" class="btn btn-secondary" onclick="generatePlanning()">Nuova
                            pianificazione</button>                    </div>
            </nav>
        </div>
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Gestione classi</h1>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            Aggiungi una nuova classe con la sua disponibilita
                        </div>
                    </div>

                    <form id="form" method="post" action="">
                        <div class="form-group row">
                            <label for="className" class="col-sm-1 col-form-label">Nome classe</label>
                            <div class="col-sm-2">
                                <input type="text" class="form-control" id="className" placeholder="I4AA"><br>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="form-group row">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding:0%"><span class="btnTable" id="1.10"
                                                onclick="colorBtn('1.10')" style="background: white;"></span></td>
                                        <td style="padding:0%"><span class="btnTable" id="2.10"
                                                onclick="colorBtn('2.10')" style="background: white;"></span></td>
                                        <td style="padding:0%"><span class="btnTable" id="3.10"
                                                onclick="colorBtn('3.10')" style="background: white;"></span></td>
                                        <td style="padding:0%"><span class="btnTable" id="4.10"
                                                onclick="colorBtn('4.10')" style="background: white;"></span></td>
                                        <td style="padding:0%"><span class="btnTable" id="5.10"
                                                onclick="colorBtn('5.10')" style="background: white;"></span></td>
                                    </tr>
                                </tbody>
                            </table>
                            <span class="btn btn-primary col-sm-1" onclick="wrapData('class')">Aggiungi classe</span>
                        </form>
                    <div><br></div>
                    <div class="card mb-4">
